const translations = {
    ...
    echoChamberRole: "Role: Project Manager, Game Designer",
    echoChamberTech: "Tech: Unity (C#)",
    echoChamberDesc1: "Designed the core loop and built level interactions.",
    echoChamberDesc2: "Managed tasks and delivery rhythm across time zones.",
    echoChamberDesc3: "Assembled demo and capture pipeline for showcase.",
    echoChamberOutcome: "Outcome: Playable demo and video walkthrough.",
    watchDemo: "Watch demo",
    mrPuzzleTitle: "MRPuzzle",
    mrPuzzleRole: "Role: Project Manager, Game Designer",
    mrPuzzleTech: "Tech: Unity (C#), MRTK, OpenXR",
    mrPuzzleDesc1: "Scoped and prioritized features for a mixed reality puzzle prototype.",
    mrPuzzleDesc2: "Implemented interaction flows and scene logic in Unity.",
    mrPuzzleDesc3: "Coordinated contributors across tasks and timelines.",
    mrPuzzleOutcome: "Outcome: Delivered a working demo video and internal playtest build.",
    mangoTVTitle: "MangoTV — Rendering & Porting (Unity)",
    mangoTVRole: "Role: Unity Developer (Porting & Performance)",
    mangoTVTech: "Tech: Unity (C#), Addressables/Streaming, Light baking, URP, NOLOVR / input remapping",
    mangoTVDesc1: "Remapped input actions and adapted camera rigs (Pico → NOLOVR) when porting between platforms.",
    mangoTVDesc2: "Reduced scene load time from ~120s to ~60s via addressables/streaming and light-baking refinements (one plugin involved).",
    mangoTVDesc3: "Prototyped MR table-top occlusion demo; documented device limits (no built-in scene-understanding; multi-camera instability); proposed Meta XR alternatives.",
    mangoTVOutcome: "Outcome: Faster load times and stable interaction mapping; delivered iterative test builds aligned to production constraints.",
    technicalNotesDemo: "Certificate",
    journeyCTMTitle: "Journey of CTM",
    journeyCTMRole: "Role: VR Developer, Designer",
    journeyCTMTech: "Tech: Unity (C#), MRTK V2.73",
    journeyCTMDesc1: "Built interactive VR scenes for cultural/educational exploration.",
    journeyCTMDesc2: "Implemented core interactions and level flow in Unity.",
    journeyCTMDesc3: "Prepared a showcase demo for competition judging.",
    ...
    // work cards
    echoChamberTitle: "EchoChamber",
    echoChamberRole: "角色：项目经理，游戏设计师",
    echoChamberTech: "技术：Unity (C#)",
    echoChamberDesc1: "设计核心循环并构建关卡交互。",
    echoChamberDesc2: "管理跨时区的任务和交付节奏。",
    echoChamberDesc3: "组装演示和捕获管道用于展示。",
    echoChamberOutcome: "成果：可玩演示和视频演练。",
    watchDemo: "观看演示",
    mrPuzzleTitle: "MRPuzzle",
    mrPuzzleRole: "角色：项目经理，游戏设计师",
    mrPuzzleTech: "技术：Unity (C#)，MRTK，OpenXR",
    mrPuzzleDesc1: "为混合现实拼图原型确定范围并优先考虑功能。",
    mrPuzzleDesc2: "在 Unity 中实现交互流程和场景逻辑。",
    mrPuzzleDesc3: "协调贡献者跨任务和时间线。",
    mrPuzzleOutcome: "成果：交付工作演示视频和内部游戏测试构建。",
    mangoTVTitle: "MangoTV — 渲染 & 移植 (Unity)",
    mangoTVRole: "角色：Unity 开发者 (移植 & 性能)",
    mangoTVTech: "技术：Unity (C#)，可寻址/流式传输，光烘焙，URP，NOLOVR / 输入重映射",
    mangoTVDesc1: "在移植平台时重新映射输入动作并调整相机支架 (Pico → NOLOVR)。",
    mangoTVDesc2: "通过可寻址/流式传输和光烘焙细化将场景加载时间从 ~120s 减少到 ~60s (涉及一个插件)。",
    mangoTVDesc3: "原型 MR 桌面遮挡演示；记录设备限制 (无内置场景理解；多摄像头不稳定)；提出 Meta XR 替代方案。",
    mangoTVOutcome: "成果：更快的加载时间和稳定的交互映射；交付迭代测试构建以符合生产约束。",
    technicalNotesDemo: "实习证明",
    journeyCTMTitle: "Journey of CTM",
    journeyCTMRole: "角色：VR 开发者，设计师",
    journeyCTMTech: "技术：Unity (C#)，MRTK V2.73",
    journeyCTMDesc1: "构建用于文化/教育探索的交互式 VR 场景。",
    journeyCTMDesc2: "在 Unity 中实现核心交互和关卡流程。",
    journeyCTMDesc3: "准备展示演示用于比赛评判。",
    ...
    mrPuzzleTitle: "MRPuzzle",
    mrPuzzleRole: "Rôle : Chef de projet, Game Designer",
    mrPuzzleTech: "Tech : Unity (C#), MRTK, OpenXR",
    mrPuzzleDesc1: "Défini et priorisé les fonctionnalités pour un prototype de puzzle en réalité mixte.",
    mrPuzzleDesc2: "Implémenté les flux d'interaction et la logique de scène dans Unity.",
    mrPuzzleDesc3: "Coordonné les contributeurs à travers les tâches et les délais.",
    mrPuzzleOutcome: "Résultat : Livré une vidéo de démo fonctionnelle et un build de test interne.",
    mangoTVTitle: "MangoTV — Rendu & Portage (Unity)",
    mangoTVRole: "Rôle : Développeur Unity (Portage & Performance)",
    mangoTVTech: "Tech : Unity (C#), Addressables/Streaming, Light baking, URP, NOLOVR / remapping d'entrée",
    mangoTVDesc1: "Remappé les actions d'entrée et adapté les rigs de caméra (Pico → NOLOVR) lors du portage entre plateformes.",
    mangoTVDesc2: "Réduit le temps de chargement de scène de ~120s à ~60s via addressables/streaming et raffinements de light baking (un plugin impliqué).",
    mangoTVDesc3: "Prototypé une démo d'occlusion de table MR ; documenté les limites de l'appareil (pas de compréhension de scène intégrée ; instabilité multi-caméra) ; proposé des alternatives Meta XR.",
