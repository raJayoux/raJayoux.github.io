const translations = {
    ...
    heroSubtitle: "Unity/XR developer — modular, device porting & Addressables + HybridCLR integration; applies URP and basic profiling.",
    ...
    journeyCTMTitle: "Journey of CTM",
    journeyCTMRole: "Role: Education-oriented VR experience",
    journeyCTMTech: "Tech: Unity (C#), MRTK V2.73",
    journeyCTMDesc1: "I handled interaction flow, level logic, and public demo preparation. Recognized at MTE 2023.",
    journeyCTMDesc2: "Emphasis on stable builds, simple review clips, and predictable demo flow for non-technical audiences.",
    journeyCTMDesc3: "",
    journeyCTMOutcome: "Outcome: Award-winning VR project recognized in Malaysia; validated learning experience via public demo.",
    projectPage: "Project page",
    demo: "Demo",
    // achievements
    achievementsTitle: "Achievements / Awards",
    mteTitle: "Malaysia Technology Expo (MTE 2023) — Gold + Special Award",
    labelOrganizer: "Organizer",
    labelDate: "Date",
    labelProject: "Project",
    labelImpact: "Impact",
    mteImpact: "Recognized by an international jury; validated a VR learning experience.",
    ...
    provincialFirstImpact: "Provincial First Prize among competing teams.",
    ...
    heroSubtitle: "Unity/XR 开发 — 模块化、设备移植与 Addressables + HybridCLR 集成；应用 URP 与基础 Profiling。",
    heroViewWork: "查看作品",
    heroContact: "联系",
    heroDownloadCV: "下载简历",
    ...
    journeyCTMTitle: "Journey of CTM",
    journeyCTMRole: "角色：教育向 VR 作品",
    journeyCTMTech: "技术：Unity (C#)，MRTK V2.73",
    journeyCTMDesc1: "负责交互流程、关卡逻辑与公开演示准备。于 MTE 2023 获奖。",
    journeyCTMDesc2: "强调稳定构建、短视频评审以及面向非技术观众的可靠演示流程。",
    journeyCTMDesc3: "",
    journeyCTMOutcome: "成果：在马来西亚获奖的 VR 项目；通过公开演示验证学习体验。",
    projectPage: "项目页面",
    demo: "演示",
    // achievements
    ...
    heroSubtitle: "Développeur Unity/XR — modulaire, portage appareils & Addressables + HybridCLR ; applique URP et profilage basique.",
    ...
    journeyCTMTitle: "Journey of CTM",
    journeyCTMRole: "Rôle : Développeur VR, Designer",
    journeyCTMTech: "Tech : Unity (C#), MRTK V2.73",
    journeyCTMDesc1: "Construit des scènes VR interactives pour l'exploration culturelle/éducative.",
    journeyCTMDesc2: "Implémenté les interactions centrales et le flux de niveau dans Unity.",
    journeyCTMDesc3: "Préparé une démo de présentation pour le jugement de compétition.",
    journeyCTMOutcome: "Résultat : Projet VR primé reconnu en Malaisie ; expérience d'apprentissage validée via démo publique.",
    projectPage: "Page du projet",
    demo: "Démo",
    // achievements
    achievementsTitle: "Réalisations / Prix",
    mteTitle: "Malaysia Technology Expo (MTE 2023) — Or + Prix Spécial",
    labelOrganizer: "Organisateur",
    labelDate: "Date",
    labelProject: "Projet",
    labelImpact: "Impact",
    mteImpact: "Reconnu par un jury international ; expérience d'apprentissage VR validée.",
    ...
    provincialFirstImpact: "Premier Prix Provincial parmi les équipes participantes.",
