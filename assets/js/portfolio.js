const I18N = {
  en: {
    ...
    aboutKicker: "About",
    aboutTitle: "About",
    about1: "I’m Pengyu — software engineer based in Paris, holding an MSc in Software Engineering from ESIGELEC (graduating September 2026), and I just finished six months shipping production Angular and C#/.NET at Presage Care in Paris.",
    ...
    resoStatus: "ACTIVE DEVELOPMENT · 2026—PRESENT",
    resoDescription: "A cross-platform AI audio product that turns a playlist into a hosted, continuously mixed listening experience.",
    resoCta: "Explore the case study →",
    resoNote: "Private source · public proof",
    rdTitle: "Panoptic segmentation",
    rdBody: "ESIGELEC research: Detectron2 Panoptic FPN on Cityscapes. Original frames vs model predictions.",
    ihTitle: "InHeritage",
    ihBody: "ESIGELEC mobile: cultural-heritage learning app. Hi-fi screens for educational content, history, and detail views.",
  ...
  fr: {
    ...
    aboutTitle: "À propos",
    about1: "Moi, c’est Pengyu — ingénieur logiciel basé à Paris, titulaire d’un Master en génie logiciel à l’ESIGELEC (diplôme en septembre 2026), je viens de passer six mois à livrer de l’Angular et du C#/.NET en production chez Presage Care à Paris.",
    ...
    resoStatus: "EN DÉVELOPPEMENT · 2026—AUJOURD’HUI",
    resoDescription: "Un produit audio IA multiplateforme qui transforme une playlist en une expérience d’écoute animée et mixée en continu.",
    resoCta: "Découvrir l’étude de cas →",
    resoNote: "Code privé · preuves publiques",
    rdTitle: "Segmentation panoptique",
    rdBody: "Recherche ESIGELEC : Detectron2 Panoptic FPN sur Cityscapes. Images d’origine vs prédictions.",
    ihTitle: "InHeritage",
    ihBody: "Mobile ESIGELEC : app d’apprentissage du patrimoine. Maquettes hi-fi (contenus, histoire, fiche détail).",
  ...
  zh: {
    ...
    dashLink: "GitHub 源码",
    resoStatus: "持续开发 · 2026年至今",
    resoDescription: "跨平台 AI 音频产品：将歌单变成有人主持、连续混播的收听体验。",
    resoCta: "查看案例研究 →",
    resoNote: "源码私有 · 成果公开",
    rdTitle: "全景分割",
    rdBody: "ESIGELEC 课题：Detectron2 Panoptic FPN，Cityscapes 原图与预测对照。",
    ihTitle: "InHeritage",
    ihBody: "ESIGELEC 移动端：文化遗产学习应用。教育内容、历史分类与详情的高保真界面。",
