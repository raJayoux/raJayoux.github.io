const I18N = {
  en: {
    ...
    aboutKicker: "About",
    aboutTitle: "About",
    about1: "Based in Paris, I hold an MSc in Software Engineering from ESIGELEC (graduating September 2026), and I just finished six months shipping production Angular and C#/.NET at Presage Care in Paris.",
  ...
  fr: {
    ...
    aboutTitle: "À propos",
    about1: "Basé à Paris, titulaire d’un Master en génie logiciel à l’ESIGELEC (diplôme en septembre 2026), je viens de passer six mois à livrer de l’Angular et du C#/.NET en production chez Presage Care à Paris.",
  ...
  zh: {
    ...
    aboutKicker: "关于",
    aboutTitle: "关于",
    about1: "我是揭鹏宇，协作时也用 raJayoux。常驻巴黎，毕业于法国 ESIGELEC 软件工程硕士（2026年9月毕业），刚在巴黎 Presage Care 完成六个月的生产环境 Angular 与 C#/.NET 全栈开发。",
